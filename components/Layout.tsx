...
const Layout = ({ children }: Props) => {
  ...
  return (
    <>
      ...
      <div>
        <div className="xl:w-[calc(100%-250px)] md:w-[calc(100%-87px)] md:ml-auto">
          <Sidebar />
          <main className="bg-gray-100 relative flex flex-col min-h-screen items-center md:flex-row">
            {children}
          </main>
